...
- `EXECUTION_CONTRACT.md`：EMS、MockFuturesExchange command port、exchange report、OrderEvent 映射、Execution Gateway command、Execution Report Normalization、Stage L.2 OMS Event Application、Stage L.3 OMS-to-Trade Bridge 和执行回报语义。
