...
ACTION_LABELS: dict[str, str] = {
    ...
    "View Result": "查看结果",
    "Refresh Health": "刷新状态",
    "Start Market Data Runtime": "启动行情运行时",
    "Stop Market Data Runtime": "停止行情运行时",
    "Poll Market Data Once": "单次刷新行情",
    "Sync Historical Bars": "同步历史行情",
...
FIELD_LABELS: dict[str, str] = {
    ...
    "historical_trading_day": "历史行情交易日",
