...
ACTION_LABELS: dict[str, str] = {
    ...
    "Open Backtest Entry": "查看本地库回测入口",
    "Open Paper Result": "查看纸面模拟结果",
    "Open Broker Read Only": "查看券商只读对照",
...
SECTION_LABELS: dict[str, str] = {
    ...
    "beginner_workflow": "新手上手流程",
    "workflow_help": "我下一步该做什么",
