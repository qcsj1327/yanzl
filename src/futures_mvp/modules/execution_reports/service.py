...
class ExecutionReportNormalizer:
    ...
    def build_normalized_report(self, raw_report: RawExecutionReport) -> NormalizedExecutionReport:
        ...
        return NormalizedExecutionReport(
            ...
            exchange_trade_id=raw_report.exchange_trade_id,
            fill_id=raw_report.fill_id,
            ...
            fee_amount=raw_report.fee_amount,
            fee_currency=raw_report.fee_currency,
            fee_source=raw_report.fee_source,
