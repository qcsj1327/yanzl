...
class Trade(Base):
    ...
    instrument_id: Mapped[str] = mapped_column(String(64), nullable=False, index=True)
    trade_instrument_id: Mapped[str | None] = mapped_column(String(64))
    ...
    source_report_id: Mapped[str | None] = mapped_column(String(128))
    source_exchange_report_id: Mapped[str | None] = mapped_column(String(128))
    source_order_event_id: Mapped[str | None] = mapped_column(String(128))
